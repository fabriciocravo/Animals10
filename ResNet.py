...
class ResNet:
    ...
    def __init__(self):
        # For the validation at every step of the training
        self.validation_data_flag = 0
        self.best_acc = 0
        ...
        # Change the last layer, train it for animal's 10!!!!!
        ...
        # Loss criterion + optimizer and learning rate
    ...
    """
        Here we train the model with the given data!!!!!
        We also check every turn to see if we should update or not the model
    """
...
if __name__ == '__main__':
    ...
    for _ in range(epochs):
        ...
        for i in range(batch_size):
            ...
            try:
                ...
                img = Image.open(path)
                img = resnet.preprocess_training_data(img)
        ...
        resnet.train_net(train_x, train_y)
    ...
    for i, key in enumerate(validation_data):
        ...
        for image_path in list_of_image_paths:
            ...
            try:
                ...
                total = total + 1
                _, predicted_class = resnet.predict_single(img)
    ...
    pkl.dump(resnet, open("./Models/ResNet_animals10.pkl", "wb"))
