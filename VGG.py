...
if __name__ == '__main__':
    ...
    for _ in range(epochs):
        ...
        for i in range(batch_size):
            ...
            try:
                ...
                img = Image.open(path)
                img = vgg.preprocess_training_data(img)
    ...
    for i, key in enumerate(validation_data):
        ...
        for image_path in list_of_image_paths:
            ...
            try:
                ...
                total = total + 1
                _, predicted_class = vgg.predict_single(img)
    ...
    pkl.dump(vgg, open("./Models/VGG_animals10.pkl", "wb"))
